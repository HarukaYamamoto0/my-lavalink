...
class Lavalink:
    def __init__(self):
        ...
        self.replace_password_command = 'sed -i "s|95941412|$PASSWORD|" application.yml'
        self.replace_password_command_no_password = 'sed -i "s|95941412|youshallnotpass|" application.yml'
